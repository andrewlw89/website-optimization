  ...
  var getPizzas = document.getElementById("randomPizzas");
    ...
    switch(size) {
      case "1":
        ...
        // add the following classes to the randomPizza divs depending on what is selected by the toggle switch
        getPizzas.className = "row smallPizza";
        break;
      case "2":
        document.getElementById("pizzaSize").innerHTML = "Medium";
        getPizzas.className = "row mediumPizza";
        break;
      case "3":
        document.getElementById("pizzaSize").innerHTML = "Large";
        getPizzas.className  = "row largePizza";
        break;
      default:
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0; i < pizzaNum; i++) {
    ...
    elem.src = "images/pizza-compressed.png";
